...
<h1><?=$title?></h1>
<?
echo form_open_multipart("/product_control/productUpdate/" . $product->id);
?>
<table>
	<tr>
		<td class="header">브랜드</td>
		<td class = "row"><?=form_input("brand", "$product->brand")?></td>
	</tr>
	<tr>
		<td class="header">제품종류</td>
		<td class = "row"><?=form_input("type", "$product->type")?></td>
	</tr>
	<tr>
		<td class="header">제품ID</td>
		<td class = "row"><input name="product_id" type="text" value="<?=$product->product_id?>"></td>
	</tr>
	<tr>
		<td class="header">제품이름</td>
		<td class = "row"><?=form_input("name", "$product->name")?></td>
	</tr>
	<tr>
		<td class="header">추천제품</td>
		<td class = "row"><?=form_input("recommand", "$product->recommand")?><br/><sub> ',' 로 구분하여 제품ID 입력</sub></td>
	</tr>
	<tr>
		<td class="header">가격</td>
		<td class = "row"><?=form_input("price", "$product->price")?></td>
	</tr>
	<tr>
		...
		<td class = "row">
			...
			<input type="radio" name="sale" value="1" <?php echo set_radio('sale', '1'); ?> />O
			<input type="radio" name="sale" value="0" <?php echo set_radio('sale', '0', TRUE); ?> />X
			<? } ?>
		</td>
	</tr>
	<tr>
		...
		<td class = "row">
			...
			<input type="radio" name="post" value="1" <?php echo set_radio('post', '1'); ?> />O
			<input type="radio" name="post" value="0" <?php echo set_radio('post', '0', TRUE); ?> />X
			<? } ?>
		</td>
	</tr>
	<tr>
		...
		<td class = "row">
			...
			<input type="radio" name="try" value="1" <?php echo set_radio('try', '1'); ?> />O
			<input type="radio" name="try" value="0" <?php echo set_radio('try', '0', TRUE); ?> />X
			<? } ?>
		</td>
	</tr>
	<tr>
		...
		<td class = "row"><div class="uploadify-queue" id="file-queue"></div>
			...
			<input type="hidden" name="image_thum" value="<?=$product->image_thum?>">
	...
	<tr>
		...
		<td class = "row"><div class="uploadify-queue" id="file-queue"></div>
			...
			<input type="hidden" name="image_detail" value="<?=$product->image_detail?>">
	...
	<tr>
		...
		<td class = "row"><div class="uploadify-queue" id="file-queue"></div>
			...
			<input type="hidden" name="image_try1" value="<?=$product->image_try1?>">
	...
	<tr>
		...
		<td class = "row"><div class="uploadify-queue" id="file-queue"></div>
			...
			<input type="hidden" name="image_try2" value="<?=$product->image_try2?>">
	...
	<tr>
		...
		<td class = "row"><div class="uploadify-queue" id="file-queue"></div>
			...
			<input type="hidden" name="video" value="<?=$product->video?>">
			<div id="videofile"></div>
		</td>
	</tr>
</table>
<?
echo form_submit("productUpdate", "수정");
echo form_close();
?>
</body>
</html>